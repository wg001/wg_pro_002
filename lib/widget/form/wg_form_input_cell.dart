...
class _JhFormInputCellState extends State<JhFormInputCell> {
  ...
  _body() {
    ...
    // 默认颜色
    var bgColor =
        WGColors.dynamicColor(context, WGColors.BgColor, WGColors.BgDarkColor);
    var titleColor = WGColors.dynamicColor(
        context, WGColors.FormTitleColor, WGColors.FormTitleDarkColor);
    ...
    var lineColor = WGColors.dynamicColor(
        context, WGColors.FormLineColor, WGColors.FormLineDarkColor);
