...
// import 'package:wg_pro_002/utils/color_utils.dart';
...
// class WgLoginTextField extends StatefulWidget {
//   const WgLoginTextField({
//     Key? key,
//     this.text = '',
//     this.hintText = '',
//     this.labelText,
...
//   @override
//   State<WgLoginTextField> createState() => _WgLoginTextFieldState();
// }

// class _WgLoginTextFieldState extends State<WgLoginTextField> {
...
//   @override
//   void didUpdateWidget(covariant WgLoginTextField oldWidget) {
...
//     // 默认颜色
//     var textColor = WGColors.dynamicColor(
//         context, WGColors.FormInfoColor, WGColors.FormInfoDarkColor);
//     var textStyle = TextStyle(fontSize: _textFontSize, color: textColor);
//     var hintColor = WGColors.dynamicColor(
//         context, WGColors.FormHintColor, WGColors.FormHintDarkColor);
//     var hintTextStyle =
//         TextStyle(fontSize: _hintTextFontSize, color: hintColor);
//     var underlineColor = WGColors.dynamicColor(context,
//         Theme.of(context).primaryColor, WGColors.FocusedBorderDarkColor);

//     // TODO: 通过ThemeProvider进行主题管理
//     final provider = Provider.of<ThemeProvider>(context);
//     var themeColor = WGColors.dynamicColor(
...
//         primarySwatch: WGColorUtils.materialColor(themeColor),
