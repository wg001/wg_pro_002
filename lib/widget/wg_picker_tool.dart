...
class BasePickerViewState extends State<BasePickerView> {
  ...
  _body() {
    var bgColor = WGColors.dynamicColor(
        context, WGColors.PickerBgColor, WGColors.PickerBgDarkColor);
    var headerColor = WGColors.dynamicColor(
        context, WGColors.PickerHeaderColor, WGColors.PickerHeaderDarkColor);
    var headerLineColor = WGColors.dynamicColor(context,
        WGColors.PickerHeaderLineColor, WGColors.PickerHeaderLineDarkColor);
    var titleColor = WGColors.dynamicColor(
        context, WGColors.PickerTitleColor, WGColors.PickerTitleDarkColor);
    var btnColor = WGColors.dynamicColor(
        context, WGColors.PickerBtnColor, WGColors.PickerBtnDarkColor);
    var selectTextColor = WGColors.dynamicColor(
        context, WGColors.PickerTextColor, WGColors.PickerTextDarkColor);
