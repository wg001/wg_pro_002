...
class ChannelFee {
    ...
    factory ChannelFee.fromJson(Map<String, dynamic> json) => _$ChannelFeeFromJson(json);
...
class DisplayList {
    ...
    factory DisplayList.fromJson(Map<String, dynamic> json) => _$DisplayListFromJson(json);
...
class IdTypeOption {
    ...
    factory IdTypeOption.fromJson(Map<String, dynamic> json) => _$IdTypeOptionFromJson(json);
...
class WithdrawChannelOption {
    ...
    factory WithdrawChannelOption.fromJson(Map<String, dynamic> json) => _$WithdrawChannelOptionFromJson(json);
